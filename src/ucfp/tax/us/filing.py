...
the survivor file SINGLE. This rule is US tax law, so it lives in tax/us; the Forecast calls
`resolve_filing_status` per year and never encodes the rule itself.
"""
