...
urlpatterns = [
    ...
    path( 'interview/vehicles/add/', views.VehicleHoldingFormView.as_view(),
          name = 'vehicle_holding_add' ),
    path( 'interview/vehicles/<str:handle>/delete/',
          views.VehicleHoldingDeleteView.as_view(), name = 'vehicle_holding_delete' ),
    path( 'interview/vehicles/leased/edit/', views.LeasedVehiclesView.as_view(),
          name = 'leased_vehicles' ),
    path( 'interview/vehicles/<str:handle>/', views.VehicleHoldingFormView.as_view(),
          name = 'vehicle_holding_edit' ),
