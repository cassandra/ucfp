...
urlpatterns = [
    ...
    path( 'plans/<uuid:uuid>/home-rent/reset/',
          views.PlansHomeRentResetView.as_view(), name = 'plans_home_rent_reset' ),
    path( 'plans/<uuid:uuid>/home-rent/keep/',
          views.PlansHomeRentKeepView.as_view(), name = 'plans_home_rent_keep' ),
    ...
    path( 'interview/advanced/economics/edit/', views.AdvancedEconomicsView.as_view(),
          name = 'advanced_economics' ),
    path( 'interview/advanced/taxes/edit/', views.TaxesView.as_view(),
          name = 'taxes' ),
    path( 'interview/advanced/ss-funding/edit/', views.SocialSecurityFundingView.as_view(),
          name = 'ss_funding' ),
    path( 'interview/advanced/net-worth/edit/', views.NetWorthView.as_view(),
          name = 'net_worth' ),
