...
urlpatterns = [
    ...
    path( 'interview/possessions/edit/', views.PossessionsView.as_view(),
          name = 'possessions' ),
    # One collection for all other property (rentals and second homes); the fixed add/delete routes precede
    # the per-property catch-all so `add` is not read as a handle.
    path( 'interview/property/add/', views.PropertyFormView.as_view(), name = 'property_add' ),
    path( 'interview/property/<str:handle>/delete/', views.PropertyDeleteView.as_view(),
          name = 'property_delete' ),
    path( 'interview/property/<str:handle>/', views.PropertyFormView.as_view(), name = 'property_edit' ),
