...
date. Survivor benefits are added by the engine's death transition (a later phase).
"""
...
def household_benefits(
    ...
    `subject_handle`: their own claim-adjusted benefit once they have claimed, and -- for the lower earner
    of a couple -- the spousal top-up once both are collecting. Not-yet-collecting is 0. A member with no
    entered entitlement yields no benefit, except a non-earning spouse in a couple whose partner has one."""
